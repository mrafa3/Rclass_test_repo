...
```{r sup_court_issue_history_viz1, include=TRUE, echo=TRUE, eval=FALSE, fig.height=7}
...
```{r sup_court_issue_history_viz2, include=TRUE, echo=TRUE, eval=FALSE, fig.height=7}
sup_court_term_issue %>% 
  filter(!is.na(issueAreaName)) %>% 
