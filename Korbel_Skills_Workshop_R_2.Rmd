...
`ggplot2` is a package for visualizing data. This will give you the building blocks for creating beautiful visualizations. There are three common elements of ggplot graphics that you will learn how to use in this session, including:  
