...
```{r gapminder_scatter_1, include=TRUE, echo=TRUE, eval=TRUE, fig.align='center'}
gapminder %>%                           #DATA
  filter(year == 2007) %>%              #DATA
...
```{r sup_court_issue_history_viz1, include=TRUE, echo=TRUE, eval=FALSE}
...
```{r sup_court_issue_history_viz2, include=TRUE, echo=TRUE, eval=FALSE}
sup_court_term_issue %>% 
  filter(!is.na(issueAreaName)) %>% 
